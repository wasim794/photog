...
<ol class="breadcrumb">
     <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Response Lead</li>
            </ol>
<div class="agile-grids">				
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h3><strong>Response Lead</strong> </h3>
		...
		<table id="table1" class="table table-responsive">
				 ...
				 <?php 
	 $query = $conn->query("select id,emp_code, service, category, date,name, phone,credit,status from booking where  status='Processing' or status='Response' order by id desc");
			       $i=0;
