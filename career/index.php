...
<html lang="en-US">
   ...
   <head>
      ...
      <link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embeded6a.json?url=https%3A%2F%2Fpromo-theme.com%2Fnovo%2Fservices%2F" />
      <link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embedcb91?url=https%3A%2F%2Fpromo-theme.com%2Fnovo%2Fservices%2F&amp;format=xml" />
      ...
      <style data-type="vc_shortcodes-custom-css">.vc_custom_1624277961356{padding-top: 47px !important;padding-bottom: 19px !important;}.vc_custom_1624278061764{padding-top: 47px !important;padding-bottom: 96px !important;}.vc_custom_1624278069533{padding-top: 22px !important;padding-bottom: 55px !important;}.vc_custom_1624278130375{margin-bottom: 48px !important;}.vc_custom_1505483962485{margin-bottom: 35px !important;}.vc_custom_1505483969540{margin-bottom: 35px !important;}.vc_custom_1505483974400{margin-bottom: 35px !important;}.vc_custom_1505483979333{margin-bottom: 35px !important;}.vc_custom_1505483984191{margin-bottom: 35px !important;}.vc_custom_1505483989290{margin-bottom: 35px !important;}.vc_custom_1624278184416{margin-bottom: 48px !important;}.vc_custom_1506084268413{margin-bottom: 30px !important;}</style>
   </head>
   <body class="page-template page-template-template-landing page-template-template-landing-php page page-id-777 theme-novo woocommerce-no-js site-dark header_type_1747 header_space_no mobile_false nav_hover_style1 lazyload_false chrome windows wpb-js-composer js-comp-ver-6.6.0 vc_responsive elementor-default elementor-kit-1731">
      <div id="all" class="site">
         ...
         <div class="side-bar-area main-row">
            ...
            <div class="wrap">
               ...
               <div id="media_gallery-2" class="widget widget_media_gallery">
                  ...
                  <div id='gallery-1' class='gallery galleryid-777 gallery-columns-3 gallery-size-thumbnail'>
         ...
         <main class="main-row">
            <div class="container">
               ...
               <div data-vc-full-width="true" data-vc-full-width-init="false" data-vc-stretch-content="true" class="vc_row wpb_row vc_row-fluid vc_row-619e00585221b vc_row-no-padding"></div>
               <div class="vc_row-full-width vc_clearfix"></div>
               <div data-vc-full-width="true" data-vc-full-width-init="false" data-vc-stretch-content="true" class="vc_row wpb_row vc_row-fluid vc_row-619e005854226 vc_row-no-padding">
                  <div class="wpb_animate_when_almost_visible wpb_fadeIn fadeIn wpb_column vc_column_container vc_col-sm-12 vc_row-619e00585434e">
               ...
               <div class="vc_row-full-width vc_clearfix"></div>
               <div class="vc_row wpb_row vc_row-fluid vc_custom_1624278069533 vc_row-5d664be2c7aac">
                  <div class="wpb_column vc_column_container vc_col-sm-12 vc_row-619e00585542b">
                           ...
                           <div class="brand-block swiper-container brand-block-5d66456614dc0" data-magic-cursor="link-w-text" data-magic-cursor-text="Drag">
                              <div class="swiper-wrapper">
                                 <div class="brand-item swiper-slide brand-item-5d6646a5dbc34 without-hover">
                                    <div class="content">
                                       <a href="#" target="_self">
                                       <img width="157" height="50" src="../wp-content/uploads/2017/08/bottom-logo-w1.png" class="attachment-full size-full" alt="" loading="lazy" />                            </a>
                                    </div>
                                 </div>
                                 <div class="brand-item swiper-slide brand-item-5d6646d2e0aa8 without-hover">
                                    <div class="content">
                                       <a href="#" target="_self">
                                       <img width="148" height="56" src="../wp-content/uploads/2017/08/bottom-logo-w2.png" class="attachment-full size-full" alt="" loading="lazy" />                            </a>
                                    </div>
                                 </div>
                                 <div class="brand-item swiper-slide brand-item-5d6646dd32221 without-hover">
                                    <div class="content">
                                       <a href="#" target="_self">
                                       <img width="185" height="79" src="../wp-content/uploads/2017/08/bottom-logo-w3.png" class="attachment-full size-full" alt="" loading="lazy" />                            </a>
                                    </div>
                                 </div>
                                 <div class="brand-item swiper-slide brand-item-5d6646e773a1a without-hover">
                                    <div class="content">
                                       <a href="#" target="_self">
                                       <img width="132" height="71" src="../wp-content/uploads/2017/08/bottom-logo-w4.png" class="attachment-full size-full" alt="" loading="lazy" />                            </a>
                                    </div>
                                 </div>
                                 <div class="brand-item swiper-slide brand-item-5d6646f0f1e4e without-hover">
                                    <div class="content">
                                       <a href="#" target="_self">
                                       <img width="148" height="61" src="../wp-content/uploads/2017/08/bottom-logo-w5.png" class="attachment-full size-full" alt="" loading="lazy" />                            </a>
                                    </div>
                                 </div>
                              </div>
                           </div>
         ...
         <footer class="site-footer custom footer-1750">
            <div class="container">
               <div class="vc_row wpb_row vc_row-fluid vc_row-619e005857afa">
                  <div class="wpb_column vc_column_container vc_col-sm-4 vc_row-619e005857be0">
                     <div class="vc_column-inner ">
                        <div class="wpb_wrapper">
                  ...
                  <div class="wpb_column vc_column_container vc_col-sm-4 vc_row-619e005857da8">
                     <div class="vc_column-inner ">
                        <div class="wpb_wrapper">
                           ...
                           <div class="project-grid-page">
                              <div class="post-gallery-grid  id-619e005857e1a grid portfolio_hover_type_1  disable-iso row popup-gallery">
      ...
      <script id='novo-script-js-after'>
         ...
         jQuery(document).ready(function(jQuery) {
                     jQuery('.testimonials-619e005853887').each(function(){
                         var head_slider = jQuery(this);
                         if(jQuery(this).find('.item').length > 1){
                             head_slider.addClass('owl-carousel').owlCarousel({
                                 loop:true,
