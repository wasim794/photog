...
if (isset($_POST['save']) && empty($_POST['id']) ) {
	...
	$off = trim($_POST['off']);
		...
		if (empty($off)) {
			...
			if(!$error) {
              $query = "INSERT INTO discount(category, title, off) VALUES('$category', '$title' , '$off')";
...
<ol class="breadcrumb">
 <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a><i class="fa fa-angle-right"></i>Add Discount </li>
            </ol>
